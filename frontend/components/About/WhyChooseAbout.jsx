      ...
      <div className="mx-auto w-full max-w-[1600px] px-5 sm:px-8 lg:px-12 xl:px-[62px]">
        <div className="overflow-hidden rounded-[16px] border border-[#EEEEEE] bg-white">
          <div className="grid lg:grid-cols-[30%_70%]">
            {/* Left Content */}
            <div className="relative overflow-hidden bg-[#F6F3FD] px-8 py-9 sm:px-10 lg:px-9 lg:py-10">
              {/* Decorative Shapes */}
              ...
              <div className="relative z-10">
                ...
                <h2 className="mt-4 max-w-[380px] text-[30px] font-bold leading-[1.08] text-[#171717] sm:text-[32px] lg:text-[34px]">
            ...
            {/* Right Features */}
            <div className="bg-white px-7 py-9 sm:px-10 lg:px-10 lg:py-10 xl:px-12">
