const specifications = [
  {
    label: "Product",
    value: "Solar Structures",
  },
  {
    label: "Structure Type",
    value: "Ground Mounted Solar Structure",
  },
  {
    label: "Alternative Type",
    value: "Rooftop Solar Structure",
  },
  {
    label: "Configuration",
...
export default function SolarSpecifications() {
  return (
        ...
        <div className="grid gap-10 lg:grid-cols-[0.75fr_1.25fr] lg:items-start">
          <div>
            ...
            <p className="mt-4 max-w-[520px] text-[14px] leading-7 text-[#666666]">
              Available solar structure configurations for Perroqueta solar
