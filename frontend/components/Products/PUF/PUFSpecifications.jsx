const specifications = [
  ...
  },
  {
    ...
    value: "Brick Red, Sky Blue, Royal Blue, Off White,Caulified Green, Bare",
  },
  {
    label: "Length",
    value: "As per requirement",
...
export default function PUFSpecifications() {
  return (
        ...
        <div className="grid gap-10 lg:grid-cols-[0.75fr_1.25fr] lg:items-start">
          <div>
            ...
            <p className="mt-4 max-w-[520px] text-[14px] leading-7 text-[#666666]">
              Standard technical information for Perroqueta PUF Panels.
            </p>
          </div>
