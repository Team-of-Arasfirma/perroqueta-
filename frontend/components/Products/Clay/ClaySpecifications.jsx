...
export default function ClaySpecifications() {
  return (
        ...
        <div className="grid gap-10 lg:grid-cols-[0.75fr_1.25fr] lg:items-start">
          <div>
            ...
            <h2 className="mt-3 text-[30px] font-bold leading-tight text-[#171717] sm:text-[36px]">
              Clay Ceiling Tile Specifications
            </h2>

            <p className="mt-4 max-w-[520px] text-[14px] leading-7 text-[#666666]">
              Standard dimensions and product information for Perroqueta Clay
              Ceiling Tiles.
            </p>
          </div>
